...
Write a program that will read a number from the user. This number will be a year. Use that given year to figure out if there was a pandemic in that year, and if there was which one.
    ...
    public static void main(String[] args) {
        ...
        if (year >= 1346 && year <= 1353){
            System.out.println("Pandemic = The Black Death");
        } else if(year == 1665 || year == 1666) {
            System.out.println("Pandemic = Great Plague of London");
        } else if (year >= 1770 && year <= 1772) {
            System.out.println("Pandemic = Russian plague");
        }else if ( year >= 1889 && year <= 1890){
                System.out.println("Pandemic = Flu pandemic");
            } else if ( year == 1916){
                System.out.println("Pandemic = American polio epidemic");
            } else if (year >= 1918 && year <= 1920){
                System.out.println("Pandemic = Spanish Flu");
            } else if (year >= 2009 && year <= 2010){
                System.out.println("Pandemic = H1N1 Swine Flu pandemic");
            } else if (year >= 2014 && year <= 2016){
                System.out.println("Pandemic = West African Ebola epidemic");
            } else if (year >= 2020 && year <= 2021) {
                System.out.println("Pandemic = COVID-19");
            }else {
